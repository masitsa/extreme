...
class Configuration extends inventory 
{
	...
	*
	*/
	public function all_units($order = 'personnel_onames', $order_method = 'ASC') 
	{
	...
	*/
	...
	{	
		...
		$v_data['leave'] = $this->personnel_model->get_personnel_jobs($personnel_id);
