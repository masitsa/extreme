...
/*$supplier_request_details = $this->requests_model->get_supplier_request_details($supplier_request_id);

if($supplier_request_details->num_rows() > 0)
{
	foreach ($supplier_request_details->result() as $key_supplier) {
		# code...

		$request_number = $key_supplier->request_number;
		...
		$supplier_request_id = $key_supplier->supplier_request_id;
