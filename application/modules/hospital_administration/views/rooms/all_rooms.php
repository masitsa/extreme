		...
		if ($query->num_rows() > 0)
		{
			...
			<table class="table table-bordered table-striped table-condensed">
				<thead>
					<tr>
						<th>#</th>
						<th><a href="'.site_url().'admin/rooms/room_name/'.$ward_id.'/'.$order_method.'/'.$page.'">Room</a></th>
						<th><a href="'.site_url().'admin/rooms/room_preffix/'.$ward_id.'/'.$order_method.'/'.$page.'">Preffix</a></th>
						<th><a href="'.site_url().'admin/rooms/room_capacity/'.$ward_id.'/'.$order_method.'/'.$page.'">Capacity</a></th>
						<th><a href="'.site_url().'admin/rooms/last_modified/'.$ward_id.'/'.$order_method.'/'.$page.'">Last modified</a></th>
						<th><a href="'.site_url().'admin/rooms/modified_by/'.$ward_id.'/'.$order_method.'/'.$page.'">Modified by</a></th>
						<th><a href="'.site_url().'admin/rooms/room_status/'.$ward_id.'/'.$order_method.'/'.$page.'">Status</a></th>
