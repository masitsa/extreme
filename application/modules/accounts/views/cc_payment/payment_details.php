                    ...
                    <div class="row">
                    	<div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="<?php echo site_url();?>accounts/cc-payment/view-payslip/<?php echo $personnel_id;?>" class="btn btn-sm btn-warning pull-right" target="_blank">View payslip</a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("accounts/cc-payment/edit-personnel-payments/".$personnel_id);?>" method="post">
                                ...
                                <div class="col-md-4">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("accounts/cc-payment/edit-personnel-benefits/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                                ...
                                <div class="col-md-4">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("accounts/cc-payment/edit-personnel-allowances/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                            ...
                            <div class="row">
                            	<div class="col-md-4">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("accounts/cc-payment/edit-personnel-deductions/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                                ...
                                <div class="col-md-4">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("accounts/cc-payment/edit-personnel-other-deductions/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                                ...
                                <div class="col-md-4">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("accounts/cc-payment/edit-personnel-relief/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                            ...
                            <div class="row">
                            	<div class="col-md-6">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("accounts/cc-payment/edit-personnel-loan-schemes/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                                                    ...
                                                    if($personnel_loan_schemes->num_rows() > 0)
													{
                                                        foreach($personnel_loan_schemes->result() as $open)
														{
                                                            ...
                                                            if($id == $loan_scheme_id)
															{
																...
																$sdate = $open->sdate;
																$edate = $open->edate;
																$prev_payments = $monthly * $this->cc_payment_model->dateDiff($sdate.' 00:00', $today.' 00:00', 'month');
																$prev_interest = $interest * $this->cc_payment_model->dateDiff($sdate.' 00:00', $today.' 00:00', 'month');
                                                                break;
                                                            }
                                                        }
                                                    }
                                ...
                                <div class="col-md-6">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("accounts/cc-payment/edit-personnel-savings/".$personnel_id);?>" method="post">
                                            <table class='table table-striped table-hover table-condensed'>
                                            <?php
                            ...
                            <div class="row">
                            	<div class="col-md-12">
                                    <section class="panel panel-featured panel-featured-info">
                                        ...
                                        <div class="panel-body">
                                        	<form action="<?php echo site_url("accounts/cc-payment/edit-payment-details/".$personnel_id);?>" method="post">
                                            	<div class="row">
                                                    <div class="col-md-3">
