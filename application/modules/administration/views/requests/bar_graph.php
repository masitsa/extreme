    ...
    <section class="panel panel-featured panel-featured-info">
        <header class="panel-heading">
            <h2 class="panel-title">Totals Invoiced Per Item As At <?php echo date('d/m/Y');?></h2>
        </header>    
...
$.ajax({
	type:'POST',
	url: config_url+"administration/charts/item_type_totals",
	cache:false,
	contentType: false,
	processData: false,
	dataType: "json",
	success:function(data){
		...
		var total_services = data.total_items;
		...
		$(function () {
			...
			function plotWithOptions() {
				$.plot($("#bar-chart"), [ d3 ], {
					...
					xaxis: {axisLabel: "Items", ticks: ticks},
