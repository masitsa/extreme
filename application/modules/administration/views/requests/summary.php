<?php 
	$requests_total = number_format($this->reports_model->get_requests_total(), 0, '.', ',');
	$approved = number_format($this->reports_model->get_approved_requests(), 0, '.', ',');
	$pending_requests = number_format($this->reports_model->get_pending_requests(), 0, '.', ',');
 ?>
 <div class="row">
            ...
            <div class="panel-body">
                <div class="widget-summary">
                    ...
                    <div class="widget-summary-col">
                        <div class="summary">
                            <h4 class="title">Requests total</h4>
                            <div class="info">
                                <strong class="amount"><?php echo $requests_total;?></strong>
                            </div>
                        </div>
                ...
                <div class="widget-summary">
                    ...
                    <div class="widget-summary-col">
                        <div class="summary">
                            ...
                            <div class="info">
                                <strong class="amount"><?php echo $pending_requests;?></strong>
                            </div>
                        </div>
                        <div class="summary-footer">
        ...
        <section class="panel panel-featured-left panel-featured-secondary">
            <div class="panel-body">
                <div class="widget-summary">
                    ...
                    <div class="widget-summary-col">
                        <div class="summary">
                            <h4 class="title">Approved Requests</h4>
                            <div class="info">
                                <strong class="amount">KSH <?php echo $approved;?></strong>
                            </div>
                        </div>
                        <div class="summary-footer">
