                        ...
                        <div class="tabbable-line">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_default_1">
									...
									echo form_open('inventory/add-service', array("class" => "form-horizontal", "role" => "form"));
									?>
                                     	<div class="row">
                                        	<div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" class="form-control" name="service_name" placeholder="Service Name" value="<?php echo $product_name;?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
